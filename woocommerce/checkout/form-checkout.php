...
<form name="checkout" method="post" class="checkout tour-checkout clearfix" action="<?php echo esc_url( $get_checkout_url ); ?>">
		...
		<div class="column fourcol">
			...
			<div class="billing-details">
				...
				<p class="form-row terms">
					...
					<label for="terms" class="checkbox"><?php _e('I accept the', 'midway'); ?> <a href="<?php echo esc_url( get_permalink(wc_get_page_id('terms')) ); ?>" target="_blank"><?php _e('terms &amp; conditions', 'midway'); ?></a></label>
				</p>
				<?php endif; ?>
	...
	<?php endif; ?>
	<div id="order_review" class="column fivecol last woocommerce-checkout-review-order">
