	...
	'components' => array(
		...
		'taxonomies' => array (
			...
			array(
				...
				'settings' => array(
					...
					'show_admin_column' => true,
					'labels' => array(
	                    'name' => __( 'Testimonial Categories', 'midway'),
	                    'singular_name' => __( 'Testimonial Category', 'midway'),
						'menu_name' => __( 'Categories', 'midway' ),
	                    'search_items' => __( 'Search Testimonial Categories', 'midway'),
	                    'all_items' => __( 'All Testimonial Categories', 'midway'),
	                    'parent_item' => __( 'Parent Testimonial Category', 'midway'),
	                    'parent_item_colon' => __( 'Parent Testimonial Category', 'midway'),
	                    'edit_item' => __( 'Edit Testimonial Category', 'midway'),
	                    'update_item' => __( 'Update Testimonial Category', 'midway'),
	                    'add_new_item' => __( 'Add New Testimonial Category', 'midway'),
	                    'new_item_name' => __( 'New Testimonial Category Name', 'midway')
	            	),
					'rewrite' => array(
						'slug' => __('testimonials', 'midway'),
						'hierarchical' => true,
					),
				),
			),
		...
		'shortcodes' => array(
			...
			array(
				'id' => 'testimonials',
				'name' => __('Testimonials', 'midway'),
				'shortcode' => '[testimonials number="{{number}}" order="{{order}}" category="{{category}}" pause="{{pause}}" speed="{{speed}}"]',
				'options' => array(
					array(
						'id' => 'number',
						'name' => __('Number', 'midway'),
