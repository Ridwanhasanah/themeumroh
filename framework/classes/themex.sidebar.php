...
class ThemexSidebar {
	...
	public static function renderSidebar($sidebar) {
		...
		$out.='<a href="#" class="themex-button themex-remove-button themex-trigger" title="'.__('Remove', 'midway').'" data-action="themex_sidebar_remove" data-element="'.$sidebar['id'].'"></a></div>';
